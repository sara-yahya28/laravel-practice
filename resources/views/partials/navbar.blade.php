<nav style="background-color: #855885; padding: 15px 30px; display: flex; justify-content: space-between; align-items: center; direction: rtl; font-family: Arial, sans-serif; box-shadow: 0 2px 5px rgba(0,0,0,0.1);margin:0;">
